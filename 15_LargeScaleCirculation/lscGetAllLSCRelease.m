% this is the key function to extract different rolls from the LSC
% the last version is <<lscGetAllLSCVer5>>
% I copied it and rename it as <<lscGetAllLSCRelease>> to record it as
% the final camera ready code for all the works

function [cLSC,aLSC,numLSC] = lscGetAllLSCRelease(x,UxColdSide,UxHotSide)
