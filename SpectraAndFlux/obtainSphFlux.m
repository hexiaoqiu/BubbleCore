% function [k,sp_ener,sp_enst,sp_entropy,sp_buoy,flux_ener,flux_enst,flux_entropy,flux_buoy]=obtainSphFlux(lightCase,t0,t1,r2D_max,r2D_min,logFile)
function [k,sp_ener,sp_enst,sp_entropy,sp_buoy,flux_ener,flux_enst,flux_entropy,flux_buoy]=obtainSphFlux(lightCase,t0,t1,r2D_max,r2D_min)
    t0_debug = clock;
