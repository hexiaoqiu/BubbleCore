function transDataFromBin( caseRawDir, storeDir)
    ...
    shiftTimeStep = 0;
    [time, maxN] = ...,
        transFieldsFromBin(caseRawDir, storeOrgDir, n1, n2, maxN, x2dGauche, x2dDroit, y2dBas, y2dHaut,shiftTimeStep,dtSave);
