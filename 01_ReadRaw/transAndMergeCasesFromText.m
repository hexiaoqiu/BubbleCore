...
function [storeDir] = transAndMergeCasesFromText(caseRawDirList, rootDir)
    ...
    for idxCase = 2:numCase
        ...
        consistency = (Ra == Ra_2)&&(Pr == Pr_2)&&(St == St_2)&&(R0 == R0_2)&&(Ff == Ff_2)&&(Delta == Delta_2)&&(x2dGauche == x2dGauche_2) ...,
    ...
    for idxCase = 1:numCase
        ...
        [time, realMaxN] = ...,
        transFields(caseRawDirList{idxCase}, storeOrgDir, n1, n2, numTimeStepList(idxCase), x2dGauche, x2dDroit, y2dBas, y2dHaut,shiftTimeStep);
