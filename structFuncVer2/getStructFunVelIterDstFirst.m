function [structFun] = getStructFunVelIterDstFirst(bubble, distanceList, orderList, NumSampPhi, NumSampTheta, winPhiMin, winPhiMax, winThetaMin, winThetaMax, Direction, timeStepStart, timeStepEnd)
    debug = 1;
    if debug == 1
        time_0 = clock;
    end
    ...
    for idxDistance = 1:numD
        ...
        if idxDistance <= 6
            ...
            [infor] = timeInfor(time_0,time_1,time_2,idxDistance,numD);
            disp(infor);
        end
