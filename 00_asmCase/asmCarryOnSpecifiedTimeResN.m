function [] = asmCarryOnSpecifiedTimeResN(asmCase,outputPath,N,time)
    if time > asmCase.dnsStopTime
        disp('The time step is out of the scope!')
        return
    end
    
    [asmCase, tmpOrgLast,u2dOrgLast,v2dOrgLast,prsOrgLast] = asmInitRead(asmCase,time);
